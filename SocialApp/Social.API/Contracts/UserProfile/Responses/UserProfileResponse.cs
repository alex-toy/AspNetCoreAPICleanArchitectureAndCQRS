...
public record UserProfileResponse()
{
    ...
    public static UserProfileResponse FromUserProfileDto(UserProfileDto profile)
    {
        ...
        profile.FriendRequests.ForEach(fr => profileResponse.FriendRequests.Add(FriendRequest.FromFriendRequestDto(fr)));
        profile.Friends.ForEach(f => profileResponse.Friends.Add(Friend.FromFriendDto(f)));
